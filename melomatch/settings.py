...
SECRET_KEY = env("SECRET_KEY", "django-insecure-9a!%cvzy)hsjsnv$#mhgeq%ja&erz=6f@yyv^otuy0c5n^_gn^")
...
DATABASES = {
    "default": {
        ...
        "NAME": env("DB_NAME", "melomatch"),
        "USER": env("DB_USER", "melomatch"),
        "PASSWORD": env("DB_PASSWORD", "melomatch"),
